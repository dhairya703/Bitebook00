...
class specialc2 extends StatefulWidget {
  @override
  _specialc2State createState() => _specialc2State();
}

class _specialc2State extends State<specialc2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('A-Block special c2'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
