...
class nonvegc1 extends StatefulWidget {
  @override
  _nonvegc1State createState() => _nonvegc1State();
}

class _nonvegc1State extends State<nonvegc1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('A-Block nonveg mess c1'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
