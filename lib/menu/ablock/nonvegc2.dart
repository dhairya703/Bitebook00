...
class nonvegc2 extends StatefulWidget {
  @override
  _nonvegc2State createState() => _nonvegc2State();
}

class _nonvegc2State extends State<nonvegc2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('A-Block nonveg mess c2'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
