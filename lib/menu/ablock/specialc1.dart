...
class specialc1 extends StatefulWidget {
  @override
  _specialc1State createState() => _specialc1State();
}

class _specialc1State extends State<specialc1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('A-Block special c1'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
