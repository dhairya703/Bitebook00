...
class vegc2 extends StatefulWidget {
  @override
  _vegc2State createState() => _vegc2State();
}

class _vegc2State extends State<vegc2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('A-Block veg mess c2 '),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
...
class MondayPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('A-Block veg mess c2 Monday Menu',style: TextStyle(color: Colors.white,fontSize: 20),
              ...
              children: <Widget>[
                ElevatedButton(
                  onPressed: () {Navigator.push(context,
                      MaterialPageRoute(builder: (context) => MondayPage()));
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => TuesdayPage()));
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => WednesdayPage()));
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => ThursdayPage()));
                  },
                  child: Text('T',style: TextStyle(fontSize: 22)),
                  style: ElevatedButton.styleFrom(primary: Colors.black,
                    onPrimary: Colors.amber,
...
class FridayPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('A-Block veg mess c2 Friday Menu',style: TextStyle(color: Colors.white,fontSize: 20),
          ),backgroundColor: Colors.purple[900],),drawer: Drawer(
      child: ListView(
        children: [
          DrawerHeader(
