...
class nonvegc5 extends StatefulWidget {
  @override
  _nonvegc5State createState() => _nonvegc5State();
}

class _nonvegc5State extends State<nonvegc5> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('C-Block nonveg mess c5'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
