...
class vegc5 extends StatefulWidget {
  @override
  _vegc5State createState() => _vegc5State();
}

class _vegc5State extends State<vegc5> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('C-Block veg mess c5'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
