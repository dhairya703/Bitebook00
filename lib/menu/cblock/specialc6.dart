...
class specialc6 extends StatefulWidget {
  @override
  _specialc6State createState() => _specialc6State();
}

class _specialc6State extends State<specialc6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('C-Block special c6'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
