...
class vegc6 extends StatefulWidget {
  @override
  _vegc6State createState() => _vegc6State();
}

class _vegc6State extends State<vegc6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('C-Block veg mess c6'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
