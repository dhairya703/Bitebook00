...
class nonvegc6 extends StatefulWidget {
  @override
  _nonvegc6State createState() => _nonvegc6State();
}

class _nonvegc6State extends State<nonvegc6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('C-Block nonveg mess c6'),),backgroundColor: Colors.purple[900],
      drawer: Drawer(
        child: ListView(
          children: [
